...
//  foodtracker
//
//  Created by Neil Ling on 2018/12/25.
...
class MealTableViewController: UITableViewController {
    ...
    */
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        case "ShowDetail":
            os_log("Showing meal detail.", log: OSLog.default, type: .debug)
            ...
            guard let selectedMealCell = sender as? MealTableViewCell else {
                fatalError("unexpected table view cell: \(sender ?? "nil sender")")
            }
        ...
        default:
            fatalError("Unexpected Segue Identifier; \(segue.identifier ?? "nil sender")")
        }
    }
    ...
    private func loadMeals() -> [Meal]? {
        do {
            ...
            os_log("Failed to load meals.", log: .default, type: .error)
        }
